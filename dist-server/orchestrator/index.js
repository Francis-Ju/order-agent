...
function buildSuggestedOrder(replenishment, lbs, promo, crossSell, ctx) {
...
export async function executeAgent(storeId, onEvent) {
    ...
    const [replenishment, lbsHotsell, promoMatch, crossSell] = await Promise.all([
        new Promise(resolve => setTimeout(() => resolve(runReplenishment(storeId, ctx)), 600)),
        new Promise(resolve => setTimeout(() => resolve(runLbsHotsell(storeId, ctx)), 900)),
        new Promise(resolve => setTimeout(() => resolve(runPromoMatch(storeId, ctx)), 1100)),
        new Promise(resolve => setTimeout(() => resolve(runCrossSell(storeId, ctx)), 800)),
    ]);
